...
//!
//! Many of the constants here are meant to be used as the length of an array.
//! In the XML they're typed as `uint32_t`. In this module they've been declared
//! as `usize` instead, so they can be used as a Rust array length without any
//! extra conversion.
...
pub const VK_MAX_GLOBAL_PRIORITY_SIZE_EXT: usize = VK_MAX_GLOBAL_PRIORITY_SIZE_KHR;
